...
#=================================================
#1. Modify default IP
sed -i 's/192.168.1.1/192.168.50.1/g' lede/package/base-files/files/bin/config_generate
...
sed -i "s/OpenWrt /lejitao build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" lede/package/lean/default-settings/files/zzz-default-settings
